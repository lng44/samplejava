...
RUN powershell -Command 'Write-Output ${env:PATH}"
RUN powershell -Command "[System.Environment]::SetEnvironmentVariable('PATH', 'C:\openjdk\bin;' + ${env:PATH}, [System.EnvironmentVariableTarget]::Machine)"
RUN powershell -Command 'Write-Output ${env:PATH}"
...
RUN powershell -Command 'Write-Output ${env:PATH}"
RUN powershell -Command "[System.Environment]::SetEnvironmentVariable('PATH', 'C:\maven\bin;' + ${env:PATH}, [System.EnvironmentVariableTarget]::Machine)"
RUN powershell -Command 'Write-Output ${env:PATH}"
